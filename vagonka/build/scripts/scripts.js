...
(function ($) {
  ...
  customSelect.each(function () {
    ...
    customSelect = '<div class="dropdown-container"><div class="dropdown-select entypo-down-open-big"><span>' + startingOption + '</span></div><ul class="dropdown-select-ul" data-role="' + listID + '">' + theOptions + '</ul></div> <!-- .custom-select-wrapper -->'; //append it after the actual select
...
(function ($) {
  ...
  function Plugin(element, options) {
    ...
    function resizeScrollbar() {
      ...
      var scrollOffset = $scrollContentEl[scrollOffsetAttr](); // scrollTop() гЃ‹ scrollLeft()
