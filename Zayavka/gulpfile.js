...
gulp.task("images", function () {
  return gulp.src(["./src/images/**/*.{jpg,jpeg,png,gif,svg}", "!./src/images/favicons/*.{jpg,jpeg,png,gif}"])
...
gulp.task("watch", function () {
  return new Promise((res, rej) => {
    ...
    watch(["./src/images/**/*.{jpg,jpeg,png,gif,svg}", "!./src/images/favicons/*.{jpg,jpeg,png,gif}"], gulp.series("images"));
    watch("./src/images/favicons/*.{jpg,jpeg,png,gif}", gulp.series("favicons"));
